...
cs.value = 0
num_pixels = 16
pixels = adafruit_dotstar.DotStar(board.GP18, board.GP19, num_pixels, brightness=0.4, auto_write=True)
...
while True:
    ...
    if pressed[0]:
        ...
        if not held[15]:
            layout.write('gAAAAABgv4Ww67lxPLRP9fWTRNihN1NXVdz_1u4EPFlvb-IviqgOF6qaOJJlCOZ4jsFhM8iRabJDtV96hYqTbD-2uqtUAoyZDk-eIANlueiRrdWB_dAiYBs=')
            kbd.send(Keycode.ENTER)
            held[15] = 1
